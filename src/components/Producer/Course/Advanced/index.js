...
class CourseAdvanced extends React.Component {
    constructor() {
        super();
    ...
    render() {
        return (
            <div className={styles.component}>
                  ...
                  <div className="row">
                    <div className="col m12 l9">
                      <div className="form-block">
                            ...
                            <label className="check-description">Ao executar esta ação <strong>NÃO</strong> será possível recuperar o curso, assim como seus Módulos e Aulas</label>
                      </div>
                    </div>
                ...
                <Dialog
                    actions={!this.state.isDeletingCourse ? [
                        <FlatButton
                            label="Cancelar"
                            primary={true}
                            onClick={() => {
                ...
                >
                    <Loading active={this.state.isDeletingCourse} />
                    {
                        !this.state.isDeletingCourse ?
                            <span>Tem certeza que deseja <strong>excluir</strong> este Curso?</span>
                        :
                            <span></span>
                    }
                </Dialog>
